...
class Auth extends CI_Controller {
	...
	function index()
	{
		...
		elseif (!$this->ion_auth->is_admin()) //remove this elseif if you want to enable this for non-admins
		{
			...
			//return show_error('You must be an administrator to view this page.');
                        ...
                        $this->data['in'] = $this->is_in();
                        $this->data['user'] = $this->ion_auth->user()->row();
                        $this->load->view('header', $this->data);
                        $this->load->view('auth/welcome', $this->data);
        ...
        function about()
        {
            $this->data['in'] = $this->is_in();     
            $this->load->view('header', $this->data);
            $this->load->view('auth/about', $this->data);
            $this->load->view('footer');
        }
        
        function is_in()
        {
            $in = $this->ion_auth->logged_in();
            return $in;
        }
	//log the user in
	function login()
	...
	function create_user()
	{
		...
		$this->form_validation->set_rules('company', 'compañia', 'required');
		$this->form_validation->set_rules('password', $this->lang->line('create_user_validation_password_label'), 'required|min_length[' . $this->config->item('min_password_length', 'ion_auth') . ']|max_length[' . $this->config->item('max_password_length', 'ion_auth') . ']|matches[password_confirm]');
		$this->form_validation->set_rules('password_confirm', 'contraseña', 'required');
